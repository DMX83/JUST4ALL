...
- este documento ya no es la fuente de verdad del modulo
- se conserva solo como lista historica de ideas de afinado para `Retrato/PRO`
- el estado real de `JUST4PICT` vive en `APPS/JUST4PICT/README.md`, `APPS/JUST4PICT/TODO.md` y `APPS/JUST4PICT/ENHANCE_ARCHITECTURE.md`
